...
data <- read.csv('/home/admins/Desktop/XSTK/gia_nha.csv', TRUE, ",")
...
lm(new_DF$price ~ new_DF$sqft_living15 + new_DF$floors + new_DF$condition
                  + new_DF$sqft_above + new_DF$sqft_living)
